            ...
            <div className='flex items-center justify-center max-w-7xl mx-auto'>
                <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10'>
                    ...
                    <div className='my-2'>
                        ...
                        <Input type='number' value={input.phoneNumber} name="phoneNumber" onChange={changeEventHandler} placeholder='Phone Number' />
                    ...
                    <span>Have an account?</span><Link to='/login' className='text-blue-600'>Login</Link>
                </form>
            </div>
        </div>
    )
