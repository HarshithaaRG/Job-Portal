...
const JobDescription = () => {
    ...
    //some is a js array method that returns true if at least one element in the array satisfies the condition
    //so it checks if any applicant for the application in the applications table equals the user id   
    const [isApplied, setIsApplied] = useState(isInitiallyApplied);
    const dispatch=useDispatch();//to dispatch actions like setting job data
            ...
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        <Badge className='text-blue-700 font-bold' variant='ghost'>{singleJob?.position} Openings</Badge>
                        <Badge className='text-red-700 font-bold' variant='ghost'>{singleJob?.jobType}</Badge>
                        <Badge className='text-black-700 font-bold' variant='ghost'>{singleJob?.salary} LPA</Badge>
                    </div>
                </div>
